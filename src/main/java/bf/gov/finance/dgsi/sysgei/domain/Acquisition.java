...
public class Acquisition extends AbstractAuditEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_app_acquisition")
    @SequenceGenerator(name = "seq_app_acquisition", sequenceName = "seq_app_acquisition",
